...
import { ClientQuestion, Answer, GradeResponse } from '@/types/quiz';
...
export const useQuizStore = create<QuizStore>()(
  persist(
    (set, get) => ({
      ...
      // Submit quiz answers
      submitQuiz: async () => {
        const { answers, startedAt, questions } = get();
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        questions: state.questions, // Need to persist questions too!
      }),
    }
  )
);
