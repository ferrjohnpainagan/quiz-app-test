...
export default function Results() {
  ...
  if (!results) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: '#E6EED6' }}>
  ...
  return (
    <div className="min-h-screen py-6 sm:py-12 px-4 pb-24 sm:pb-12" style={{ background: '#E6EED6' }}>
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl p-6 sm:p-10 border border-[#DDE2C6]">
          ...
          <div className="text-center mb-8">
            <div className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 shadow-md ${
              isPassing ? 'bg-gradient-to-br from-green-400 to-green-500' : 'bg-gradient-to-br from-[#BBC5AA] to-[#DDE2C6]'
            }`}>
              {isPassing ? (
                ...
                <svg className="w-10 h-10 text-[#090C02]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Question Results */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-[#090C02] mb-5">Question Breakdown</h3>
